"""
OpenSchool Projekt Labor — Verifikációs tesztek
Közös fixture-ök és konfigurációs beállítások.

Használat:
  1. Másold a tesztek/ mappát a openschool-platform repó gyökerébe
  2. cd openschool-platform
...
# A openschool-platform repó gyökere (a tesztek/ mappa szülője)
REPO_ROOT = Path(__file__).parent.parent


@pytest.fixture
def repo_root():
    """A openschool-platform repó gyökérmappája."""
    return REPO_ROOT
