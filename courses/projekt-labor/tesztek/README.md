...
|-------|----------|----------|------------|
| **Saját tesztek** | Te, a modul feladataként | `openschool-platform/backend/tests/` | Fejlesztés közben, CI-ban |
| **Verifikációs tesztek** | A kurzusanyag adja | `openschool-platform/tesztek/` | Modul befejezésekor |
