...
- **Automatizált + emberi értékelés:** A GitHub Classroom autograding ad egy objektív alappontszámot, de a mentori kód-átnézés (code review) is része az értékelésnek.
...
- A tanuló segíthet a gyengébb társaiknak (pair programming)
...
**Az autograding az alap, nem a plafon.** A számítógép megmondja, hogy működik-e a kód — a mentor dönti el, hogy a tanuló érti-e és önállóan készítette-e.
