...
Hozz létre egy `.env` fájlt az `eszkozok/` mappában (ez a fájl `.gitignore`-ban van, nem kerül verziókezelésbe):
...
python eszkozok/discord-webhook.py uzenet python10 "🧪 Teszt üzenet – ha ezt látod, a webhook működik!"
```
