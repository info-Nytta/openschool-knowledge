...
| Platform repó | `devschool-platform` (külön repó) |
...
```bash
# A devschool repóból másold a teszteket a platform repóba
...
- Markdown → HTML rendering (kurzus tartalmak a DevSchool repóból)
- Landing page: mi a DevSchool, hogyan működik, kurzuslista
...
**Eredmény:** A devschool.hu-n megjelenik a teljes weboldal: kurzusok böngészése, belépés, haladás követése.
