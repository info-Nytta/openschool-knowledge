...
A DevSchool open source — a licencnek engedélyeznie kell a szabad felhasználást.
...
A DevSchool közösségben négy szint van:
...
A `devschool-platform` repó eseményei jelenjenek meg a Discord szerveren.
