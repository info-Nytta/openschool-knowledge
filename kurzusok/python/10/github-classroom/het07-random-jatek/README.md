...
## 7.3 – Kő-papír-olló ⭐⭐
Írj programot (`feladat3.py`). Készíts kő-papír-olló játékot! A gép véletlenszerűen választ, a játékos billentyűzetről. Írd ki, ki nyert.

## 7.4 – Lottóhúzás ⭐⭐
Írj programot (`feladat4.py`). Generálj 5 különböző véletlenszámot 1 és 90 között! (Ügyelj rá, hogy ne ismétlődjenek!) Rendezd sorba és írd ki.
